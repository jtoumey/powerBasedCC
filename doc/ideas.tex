...
\begin{itemize}
   ...
   \item General steps\todo{any thoughts on this procedure?}
   \begin{enumerate}
...
\begin{itemize}
   \item Touch screen\todo{do you know if any units have touch screen and buttons? actually i think the pioneer head unit does.. maybe EDGE 510 as well? have to look how touch screen perform when sweat/wet}
      \begin{itemize}
         \item Resistive
